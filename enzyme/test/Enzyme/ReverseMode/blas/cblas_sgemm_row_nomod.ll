...
;CHECK-NEXT:  call void @cblas_sgemm(i32 101, i32 111, i32 112, i32 2, i32 3, i32 2, float %alpha, float* nocapture readonly %"C'", i32 2, float* nocapture readonly %B, i32 2, float 0x36A0000000000000, float* %"A'", i32 3)
;CHECK-NEXT:  call void @cblas_sgemm(i32 101, i32 112, i32 111, i32 3, i32 2, i32 2, float %alpha, float* nocapture readonly %A, i32 3, float* nocapture readonly %"C'", i32 2, float 0x36A0000000000000, float* %"B'", i32 2)
